...
form.onsubmit = (e) => {
  ...
  if (form.checkValidity()) {
    if (dropDown.value == "normal") {
      ...
      // بعد 2 ثواني من ظهور رسالة النجاح
      setTimeout(() => {
        // إظهار شاشة التحميل
        ...
        // بعد 3 ثواني من ظهور اللودينج
        setTimeout(() => {
          // الانتقال للصفحة الجديدة
          window.location.href = "../Choose_Real_OR_Sim/index.html";
        }, 3000);
      }, 2000);
...
window.onload = function () {
  ...
  setTimeout(() => {
    ...
    // الانتظار حتى اكتمال تأثير التلاشي
    setTimeout(() => {
      loadingScreen.style.display = "none";
      document.body.style.overflow = "auto";
      
      // تحميل بيانات المستخدم وتهيئة الصفحة
      checkUserType();
      loadUserData();
    }, 500);
  }, 3000);
